 ...
 * @author ARIF
 */
public class Kalkulator_ARIFATWA extends javax.swing.JFrame {
    String angka;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kalkulator_ARIFATWA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Kalkulator_ARIFATWA().setVisible(true);
            }
        });
    }
